 ...
 * @author B11
 */
public class ventanitaconversion extends javax.swing.JFrame {

    /**
     * Creates new form ventanitaconversion
     */
    public ventanitaconversion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Convertir Dolar a Pesos Colombianos");

        lbDolares.setText("Dolares");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(150, 157, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtDolares, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                    .addComponent(txtCOP))
                .addGap(64, 64, 64))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        double dolares, pesos, conversion;
        dolares= Double.valueOf(txtDolares.getText());
        conversion=(dolares*4776.45);
        txtCOP.setText(String.valueOf(Math.round(conversion)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanitaconversion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanitaconversion().setVisible(true);
            }
        });
    }
